const timezoneData = [
    ...
    { label: '(GMT+00:00) America/Scoresbysund', value: 'America/Scoresbysund' },
    ...
    { label: '(GMT+03:00) Africa/Dar es Salaam', value: 'Africa/Dar_es_Salaam' },
    ...
    { label: '(GMT+09:30) Australia/Broken Hill', value: 'Australia/Broken_Hill' },
    ...
    { label: '(GMT+12:00) Antarctica/South Pole', value: 'Antarctica/South_Pole' },
    ...
    { label: '(GMT-04:00) America/Indiana/Indianapolis', value: 'America/Indiana/Indianapolis' },
    { label: '(GMT-04:00) America/Indiana/Marengo', value: 'America/Indiana/Marengo' },
    { label: '(GMT-04:00) America/Indiana/Petersburg', value: 'America/Indiana/Petersburg' },
    { label: '(GMT-04:00) America/Indiana/Vevay', value: 'America/Indiana/Vevay' },
    { label: '(GMT-04:00) America/Indiana/Vincennes', value: 'America/Indiana/Vincennes' },
    { label: '(GMT-04:00) America/Indiana/Winamac', value: 'America/Indiana/Winamac' },
    { label: '(GMT-04:00) America/Indianapolis', value: 'America/Indianapolis' },
    { label: '(GMT-04:00) America/Iqaluit', value: 'America/Iqaluit' },
    { label: '(GMT-04:00) America/Kentucky/Louisville', value: 'America/Kentucky/Louisville' },
    { label: '(GMT-04:00) America/Kentucky/Monticello', value: 'America/Kentucky/Monticello' },
    ...
    { label: '(GMT-04:00) America/Port-au-Prince', value: 'America/Port-au-Prince' },
    ...
    { label: '(GMT-05:00) America/Bahia Banderas', value: 'America/Bahia_Banderas' },
    ...
    { label: '(GMT-05:00) America/Indiana/Knox', value: 'America/Indiana/Knox' },
    { label: '(GMT-05:00) America/Indiana/Tell City', value: 'America/Indiana/Tell_City' },
    ...
    { label: '(GMT-05:00) America/North Dakota/Beulah', value: 'America/North_Dakota/Beulah' },
    { label: '(GMT-05:00) America/North Dakota/Center', value: 'America/North_Dakota/Center' },
    { label: '(GMT-05:00) America/North Dakota/New Salem', value: 'America/North_Dakota/New_Salem', },
    ...
    { label: '(GMT-05:00) America/Rankin Inlet', value: 'America/Rankin_Inlet' },
    ...
    { label: '(GMT-06:00) America/Cambridge Bay', value: 'America/Cambridge_Bay' },
    ...
    { label: '(GMT-07:00) America/Santa Isabel', value: 'America/Santa_Isabel' },
